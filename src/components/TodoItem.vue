<template>
    <div v-if="isEditing">
        <TodoItemEditForm :id="id" :label="label" @item-edited="itemEdited" @edit-cancelled="editCancelled" />
    </div>
    <div v-else class="stack-small">
        ...
        <div class="btn-group">
            <button ref="editButton" type="button" class="btn" @click="toggleTodoItemEditForm">
